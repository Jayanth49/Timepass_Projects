...
num_training_per_class = [2]#, 10, 20, 30, 40, 50]
all_accuracies = []
...
for num_train in num_training_per_class:
    ...
    model = gpflow.models.VGP(data=(x_train, y_train),
                              ...
                              kernel=gpflow_new_kernels.ExpWassWithPsdApproximation(
                                  cost_matrix=m, initial_variance=100.0, initial_scale=1.0, reg=0.4, stopThr=5e-2,
